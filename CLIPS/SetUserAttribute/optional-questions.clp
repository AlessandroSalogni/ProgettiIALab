...
(deffacts OPTIONAL-QUESTIONS::define-requests
  ...
  (menu-request (search-parameter start) (request "Which search parameter would you like to set?") (valid-answers destination facility group-detail number-days end))
  ...
  (preference-request (search-parameter group-detail) (request "Which of them is present?"))
  (preference-request (search-parameter number-days) (request "How many nights?"))
)
