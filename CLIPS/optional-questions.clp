...
(deffacts OPTIONAL-QUESTIONS::define-requests
  ...
  (menu-request (search-parameter start) (request "Which search parameter would you like to set? ") (valid-answers destination facility group-detail end))
  (menu-request (search-parameter destination) (request "Which search parameter of destination would you like to set? ") (valid-answers region turism number-places number-days end))
