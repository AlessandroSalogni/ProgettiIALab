...
(deffacts OPTIONAL-QUESTIONS::define-requests
  ...
  (menu-request (search-parameter start) (request "Which search parameter would you like to set? ") (valid-answers destination facility other end))
  ...
  (menu-request (search-parameter other) (request "Would you tell me something more about pet-presence - disability - children - number-days? ") (valid-answers pet-service disability children number-days end))
  (preference-request (search-parameter pet-service) (request "Any pets with you? "))
  (preference-request (search-parameter children) (request "Any children with you? "))
  (preference-request (search-parameter disability) (request "Any people with disability? "))
  (preference-request (search-parameter number-days) (request "How much days? "))
)
