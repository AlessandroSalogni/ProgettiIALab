...
tratta(Linea,Dir,SP,SA) :- percorso(Linea,Dir,LF), member_pair(SP,SA,LF), \+chiuso(SP, SA).
...
stazione("Chiswick Park", -0.266981606, 51.49415785).
stazione("Wimbledon Park", -0.19749098, 51.43353749).
stazione("Southfields", -0.205058529, 51.4445635).
stazione("Seven Sisters", -0.070894139, 51.58289546).
stazione("Blackhorse Road", -0.040174342, 51.58633801).
stazione("Tottenham Hale", -0.058547162, 51.58754655).
stazione("Brent Cross", -0.212185251, 51.57616797).
stazione("Golders Green", -0.192420671, 51.57178437).
...
stazione("Wood Green", -0.108246806, 51.5969712).
stazione("Bounds Green", -0.122731021, 51.60656487).
stazione("West Ham", 0.00590508, 51.52776913).
stazione("Walthamstow Central", -0.019895332, 51.58261626).
stazione("Ealing Broadway", -0.299418497, 51.51449777).
stazione("Acton Town", -0.278432824, 51.50213702).
stazione("Ealing Common", -0.286555479, 51.50903565).
...
stazione("Colliers Wood", -0.176460893, 51.41763979).
stazione("Tooting Broadway", -0.166791248, 51.42715702).
stazione("Tooting Bec", -0.15763366, 51.4353811).
stazione("Balham", -0.151090206, 51.44310998).
stazione("Hendon Central", -0.224748399, 51.58267136).
stazione("Wimbledon", -0.204921053, 51.42091587).
stazione("Turnham Green", -0.252958803, 51.494448).
stazione("Neasden", -0.24957656, 51.5539234).
stazione("Dollis Hill", -0.237445148, 51.55145847).
stazione("Stonebridge Park", -0.27487576, 51.54368887).
stazione("Willesden Junction", -0.242978972, 51.5318981).
stazione("East Finchley", -0.163438627, 51.58665344).
stazione("Highgate", -0.144860652, 51.577342).
stazione("West Acton", -0.279364414, 51.51747345).
stazione("Stratford", -0.002182514, 51.54094802).
...
chiuso("Holland Park", "Notting Hill Gate").
chiuso("Stepney Green", "Mile End").
chiuso("Canada Water", "Canary Wharf").
chiuso("Mile End", "Stepney Green").
chiuso("Canary Wharf", "Canada Water").
